...
namespace LiveSplit.OriDE.Settings {
    public partial class OriSettings : UserControl {
        ...
        public XmlNode UpdateSettings(XmlDocument document) {
            ...
            XmlElement xmlEnergyShard = document.CreateElement("EnergyShardDisplay");
            xmlEnergyShard.InnerText = EnergyShardDisplay.ToString();
            xmlSettings.AppendChild(xmlEnergyShard);
        ...
        public void SetSettings(XmlNode settings) {
            ...
            XmlNode showEnergyShard = settings.SelectSingleNode(".//EnergyShardDisplay");
            if (showEnergyShard != null && showEnergyShard.InnerText != "") {
                EnergyShardDisplay = bool.Parse(showEnergyShard.InnerText);
            } else {
                EnergyShardDisplay = false;
            }
